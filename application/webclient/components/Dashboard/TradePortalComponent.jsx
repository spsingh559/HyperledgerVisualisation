    ...
    // let retrievedUserDetails= JSON.parse(sessionStorage.getItem('userLoginDetails'));
      return (
        ...
        <Subheader style={{fontWeight: 'bold',color: '#333333'}}>Trade Portfolio
               {/* <img src="images/shell.jpg" style={{  width: '53px',height: '49px',float:'right',marginTop: '20px'}}  /> */}
               </Subheader>
               <Subheader style={{fontWeight: 'bold',color: '#333333',fontSize: '18px',lineHeight: "2"}}>User </Subheader>
        </div>
